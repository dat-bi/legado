...
object RssParserDefault {
    ...
    fun parseXML(
        ...
        articleList.firstOrNull()?.let {
            Debug.log(sourceUrl, "┌Thu hoạch tiêu đề")
            Debug.log(sourceUrl, "└${it.title}")
            Debug.log(sourceUrl, "┌Thu hoạch thời gian")
            Debug.log(sourceUrl, "└${it.pubDate}")
            Debug.log(sourceUrl, "┌Thu hoạch Mô tả")
            Debug.log(sourceUrl, "└${it.description}")
            Debug.log(sourceUrl, "┌Thu hoạch url ảnh")
            Debug.log(sourceUrl, "└${it.image}")
            Debug.log(sourceUrl, "┌Thu hoạch link bài viết")
